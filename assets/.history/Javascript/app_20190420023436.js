...
function showGifs(imgSet){
  ...
  for (var i = 0; i < imgSet.length; i++) {
    ...
    var infoText = "Title: " + imgSet[i].title + '</br>'
    infoText = infoText +"Rating: " + imgSet[i].rating + '</br>'
    infoText = infoText + "Height:" + imgSet[i].images.fixed_height_still.height + '</br>'
    infoText = infoText + "Width:" + imgSet[i].images.fixed_height_still.width+'</br>'
    $(".info").text(infoText);
