...
function getGif(myTopic){
  ...
  function showGifs(imgSet){
    ...
    for (var i = 0; i < imgSet.length; i++) {
      ...
      $(".gif").attr("src",imgSet[i].images.fixed_height_still.url);
      $(".gif").attr("data-still",imgSet[i].images.fixed_height_still.url);
      $(".gif").attr("data-animate", imgSet[i].images.fixed_height.url);
